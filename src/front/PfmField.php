...
class PfmField
{
    ...
    public function getTextField($data, $user_id)
    {
        ...
        return "<input type=" . (empty($isHidden) ? 'text' : 'hidden') . " placeholder='$placeholder' class='form-control " . $class . "'" . " name='$metadata' value='$value'" . (empty($isRequired) ? '' : 'required') . ">";
    ...
    public function getDateField($data, $user_id)
    {
        ...
        return "<input id='datepicker' type=" . (empty($isHidden) ? 'text' : 'hidden') . " placeholder='$placeholder' class='form-control " . $class . "'" . " name='$metadata' value='$value'" . (empty($isRequired) ? '' : 'required') . ">";
    ...
    public function getPasswordField($data, $user_id)
    {
        ...
        return "<input type=" . (empty($isHidden) ? 'password' : 'hidden') . " placeholder='$placeholder' class='form-control " . $class . "'" . " name='$metadata' value='$value'" . (empty($isRequired) ? '' : 'required') . ">";
    ...
    public function getEmailField($data, $user_id)
    {
        ...
        return "<input type=" . (empty($isHidden) ? 'email' : 'hidden') . " placeholder='$placeholder' class='form-control " . $class . "'" . " name='$metadata' value='$value'" . (empty($isRequired) ? '' : 'required') . ">";
    ...
    public function getSelectField($data, $user_id)
    {
        ...
        $selectField = '<select class="form-control" name="' . $metadata . '"' . (empty($isRequired) ? '' : 'required') . '>';
    ...
    public function getWysiwygField($data, $user_id)
    {
        ...
        // return "<textarea name='$metadata' class='$class' ".(empty($isRequired) ? '' : 'required').">". (empty($value)? $default : $value) ."</textarea>";
        return (new admin\PfmEditor)->render($value, $metadata, $metadata);
    ...
    public function getByMetaname($metaname)
    {
        $metadatas = get_option('pfm_metadata', true);
        return $metadatas[$metaname];
    }
}
