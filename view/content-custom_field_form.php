<div class="hidden-custom-field-form" style="display: none;">
...
<div class="registration-form">
	...
	<div class="form-group">
		...
		<input class="form-control metadata registration_form_maker_meta" type="text" name="data[][metadata]" value="<?= $pfm_metadata['metadata'] ?>" required/>
	</div>
	<div class="form-group">
